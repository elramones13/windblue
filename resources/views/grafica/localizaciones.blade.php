...
<body>
<h3 id="titulot">Gráfica del número de inmersiones por localizaciones</h3>
<a href=" {{url('/dashboard')}}" class="btn btn-success fas fa-home" padding="10px"></a>
<a href=" {{url('/localizaciones')}}" class="btn btn-primary fas fa-step-backward" padding="10px"></a>
